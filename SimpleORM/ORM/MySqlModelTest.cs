...
{
    class MySqlModelTest<T> : Model<T>, IModel<T, MySqlModelTest<T>>
    {
        ...
        public MySqlModelTest<T> and(string field, string comparisonOperator, object value)
        {
        ...
        public MySqlModelTest<T> find<U>(U value)
        {
        ...
        public MySqlModelTest<T> groupby(string field)
        {
        ...
        public MySqlModelTest<T> logicalOperatorBuilder(string logicalOperator, string field, string comparisonOperator, object value)
        {
            // Group By
        ...
        public MySqlModelTest<T> or(string field, string comparisonOperator, object value)
        {
            return logicalOperatorBuilder("or", field, comparisonOperator, value);
        }

        public MySqlModelTest<T> orderby(string field, string sort)
        {
        ...
        public MySqlModelTest<T> select(string fields)
        {
        ...
        public MySqlModelTest<T> where(string field, string comparisonOperator, object value)
        {
